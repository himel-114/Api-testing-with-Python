...
from test_data.user_api.country_api_data import response_get_bd_data


@allure.step('response_get_bd_data')
def test_bd():
    response_body, status_code = response_get_bd_data()
    print(response_body)
    print("\n")
    ...
    print(response_body[0]["tld"])
    print(response_body[0]["idd"])
